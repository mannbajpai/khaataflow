...
const GroupExpenseItem = ({
  ...
  <li className="bg-gray-100 p-2 rounded md:flex sm:flex-row md:justify-between sm:justify-center items-center">
    ...
    <div className="text-right">
      ...
      <span className="block text-sm text-gray-500">Split: {expense.type}</span>
    </div>
    <div className="mt-4">
    ...
    {expense.lenderId !== user.id ? (
      <div className="m-4">
        <Link
          to={`/group/${groupId}/expense/${expense.id}`}
      ...
      <div className="m-4 flex flex-col">
        <Link
          to={`/group/${groupId}/expense/${expense.id}/edit`}
          className="btn bg-yellow-400 hover:bg-yellow-200 my-2"
        >
          Edit
        </Link>
