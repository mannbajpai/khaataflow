...
const LendedSplits = ({ splits }) => {
  ...
  return (
    <div className="mb-4 p-4 bg-white shadow-md rounded-lg">
      <h3 className="text-xl font-bold mb-4 text-turquoise-green">
        Lended Splits
      </h3>
            ...
            {memoizedExpenseSplits.map((expense) =>
              expense.splits.map((split, splitIndex) => (
                ...
                >
                  ...
                  <td className="py-2 px-4 border-b">
                    <span
                      className={`py-1 px-2 rounded-full text-xs font-semibold ${split.settled ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'}`}
                    >
                  ...
                  {split.settled ? (
                    <td className="py-2 px-4 border-b">
                      <button
                        ...
                        className="btn btn-sm text-red-700 bg-red-200 hover:bg-red-100"
                      >
                        Delete
                      </button>
                    </td>
                    ...
                    <td className="py-2 px-4 border-b">
                      <button
                        ...
                        className="btn btn-sm text-blue-700 bg-blue-200 hover:bg-blue-100"
                      >
                        Settle
                      </button>
                    </td>
