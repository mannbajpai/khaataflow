  ...
  return (
    <div className="navbar px-8 rounded-3xl bg-turquoise-green text-primary-content">
      ...
      <div className="navbar-center">
        <Link to="/home" className="btn btn-ghost text-xl sm:text-2xl">khaataFlow</Link>
      </div>
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          <span className="text-xl font-semibold lg:absolute top-2 right-12 sm:block hidden">{user.username}</span>
