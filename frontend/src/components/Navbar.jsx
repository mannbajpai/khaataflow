  ...
  return (
    <div className="navbar px-8 rounded-3xl bg-turquoise-green text-primary-content">
      <div className="navbar-start">
        <Link to={link} className="btn btn-ghost btn-circle">
      ...
      <div className="navbar-center">
        <Link to="/home" className="btn btn-ghost text-xl sm:text-2xl">
          khaataFlow
        </Link>
      </div>
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          <span className="text-xl font-semibold lg:absolute top-2 right-12 sm:block hidden">
            {user.username}
          </span>
          <div
            tabIndex={0}
          ...
          >
            <div className="w-10 rounded-full">
              <img alt="User Profile" src={user.profilePhoto || defaultUser} />
            </div>
          </div>
          <ul
            tabIndex={0}
            className={`menu menu-lg dropdown-content font-semibold bg-base-200 rounded-box z-[1] mt-3 w-52 p-2 shadow ${isMenuVisible ? 'visible' : 'hidden'}`}
          >
            <li>
